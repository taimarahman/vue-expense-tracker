...
const selectedDate = ref(props.modelValue ? convertToMMDDYYYY(props.modelValue) : '')
...
<template>
    <div class="relative h-max">
      ...
      <div class="pointer-events-none absolute-middle right-5">
        <svg
          width="20"
          height="18"
          viewBox="0 0 20 18"
