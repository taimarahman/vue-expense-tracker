...
<template>
  <div ref="target" class="relative">
    <button class="flex items-center gap-1.5 md:gap-2.5" @click.prevent="dropdownOpen = !dropdownOpen">
      <!-- profile img -->
      ...
      <span class="hidden text-right lg:block">
        <span class="block text-base text-white">{{
    ...
    >
      <ul class="flex flex-col">
        <li>
          <button class="list-item" to="#">My Profile</button>
        </li>
        <!-- <li>
          <button @click="navigateToTab('company')" class="list-item">My Company</button>
        </li>
        <li>
          <button @click="navigateToTab('team')" class="list-item">Team Management</button>
        </li>
        <li>
          <router-link to="#" class="list-item">Department Management</router-link>
        </li>
        <li>
          <router-link to="#" class="list-item">Admin Settings</router-link>
        </li>
        <li>
          <router-link to="#" class="list-item">Integration</router-link>
        </li>
        <li>
          <router-link to="#" class="list-item">Refer & Earn</router-link>
        </li>
        <li>
          <router-link to="#" class="list-item">Help Centre</router-link> 
        </li> -->
      </ul>
